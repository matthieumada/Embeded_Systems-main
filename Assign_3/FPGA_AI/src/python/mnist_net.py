...
# Launch the code with the following line :
# python3 mnist_net.py -dataset_dir /home/delinm/Documents/Embeded_Systems-main/Assign_3/FPGA_AI/src/python/MNIST_Dataset_JPG
def main():
	args = sys.argv[1:]
