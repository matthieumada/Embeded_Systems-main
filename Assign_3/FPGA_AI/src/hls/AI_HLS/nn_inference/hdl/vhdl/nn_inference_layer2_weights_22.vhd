...
entity nn_inference_layer2_weights_22_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of nn_inference_layer2_weights_22_rom is 
...
entity nn_inference_layer2_weights_22 is
    generic (
...
architecture arch of nn_inference_layer2_weights_22 is
    component nn_inference_layer2_weights_22_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    nn_inference_layer2_weights_22_rom_U :  component nn_inference_layer2_weights_22_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
